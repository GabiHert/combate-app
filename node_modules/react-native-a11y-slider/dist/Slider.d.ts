...
export declare type SliderProps = AccessibilityProps & {
    values: SliderValue[];
    min?: number;
    max?: number;
    increment?: number;
...
declare const _default: React.MemoExoticComponent<({ min, max, values, sliderValues, markerColor, showLabel, style, trackStyle, selectedTrackStyle, increment, onChange, onSlidingStart, onSlidingComplete, labelComponent, setA11yMarkerProps, markerComponent, ...accessibilityProps }: SliderProps) => JSX.Element>;
