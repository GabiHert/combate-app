...
export default React.memo(function (_a) {
    var min = _a.min, max = _a.max, values = _a.values, sliderValues = _a.sliderValues, _b = _a.markerColor, markerColor = _b === void 0 ? "#333" : _b, _c = _a.showLabel, showLabel = _c === void 0 ? true : _c, style = _a.style, trackStyle = _a.trackStyle, selectedTrackStyle = _a.selectedTrackStyle, _d = _a.increment, increment = _d === void 0 ? 1 : _d, onChange = _a.onChange, onSlidingStart = _a.onSlidingStart, onSlidingComplete = _a.onSlidingComplete, labelComponent = _a.labelComponent, setA11yMarkerProps = _a.setA11yMarkerProps, _e = _a.markerComponent, markerComponent = _e === void 0 ? Marker : _e, accessibilityProps = __rest(_a, ["min", "max", "values", "sliderValues", "markerColor", "showLabel", "style", "trackStyle", "selectedTrackStyle", "increment", "onChange", "onSlidingStart", "onSlidingComplete", "labelComponent", "setA11yMarkerProps", "markerComponent"]);
