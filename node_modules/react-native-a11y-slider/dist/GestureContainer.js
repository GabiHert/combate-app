...
export default React.memo(function (_a) {
    var type = _a.type, sliderType = _a.sliderType, markerCount = _a.markerCount, minValue = _a.minValue, maxValue = _a.maxValue, position = _a.position, stops = _a.stops, _b = _a.showLabel, showLabel = _b === void 0 ? true : _b, markerColor = _a.markerColor, panBoundariesProp = _a.panBoundaries, setIndexProp = _a.setIndex, _c = _a.labelComponent, LabelComponent = _c === void 0 ? Label : _c, _d = _a.markerComponent, MarkerComponent = _d === void 0 ? Marker : _d, onSlidingStart = _a.onSlidingStart, onSlidingComplete = _a.onSlidingComplete, setA11yMarkerProps = _a.setA11yMarkerProps, accessibilityProps = __rest(_a, ["type", "sliderType", "markerCount", "minValue", "maxValue", "position", "stops", "showLabel", "markerColor", "panBoundaries", "setIndex", "labelComponent", "markerComponent", "onSlidingStart", "onSlidingComplete", "setA11yMarkerProps"]);
